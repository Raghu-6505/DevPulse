...
function Sidebar() {
  ...
  return (
    <div
      className={`fixed z-20 bg-2 h-full border-r-[2px] border-rgba-3 ${
        isSidebarOpen ? "w-[15rem]" : "w-[5.2rem]"
      }`}
    >
      <span
        className="u-shadow-2 w-[45px] absolute z-50 top-[21px] right-[-47px] py-[0.8rem] bg-1 cursor-pointer
